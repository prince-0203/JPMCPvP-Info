...
//
// RecentStats<https://gist.github.com/nanashell2055/489cdd33deb0fe39eaa1> をJavascriptに移植・一部改変、新APIに対応させたものです。
...
//   RecentStatsを計算し、結果を返します。エラーが発生した場合、nullを返します。
//
